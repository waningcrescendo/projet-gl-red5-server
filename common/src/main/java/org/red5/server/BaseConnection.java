...
public abstract class BaseConnection extends AttributeStore implements IConnection {
  ...
  /** Listeners */
  protected transient CopyOnWriteArraySet<IConnectionListener> connectionListeners =
  ...
  public BaseConnection(
    ...
    log.debug(
        "New BaseConnection - type: {} host: {} remoteAddress: {} remotePort: {} path: {} sessionId: {}",
  ...
  public void setId(int clientId) {
    log.warn(
        "Setting of a client id is deprecated, use IClient to manipulate the id",
        new Exception("RTMPConnection.setId is deprecated"));
  }

...
public abstract class AbstractScopeAdapter implements IScopeHandler {
   ...
   * Can start flag. <code>
   * true
   * </code> if scope is ready to be activated, <code>
   * false
   * </code> otherwise
   */
  ...
  /**
   * Can connect flag. <code>
   * true
   * </code> if connections to scope are allowed, <code>
   * false
   * </code> otherwise
   */
   ...
   * Can join flag. <code>
   * true
   * </code> if scope may be joined by users, <code>
   * false
   * </code> otherwise
   */
  ...
  /**
   * Can call service flag. <code>
   * true
   * </code> if remote service calls are allowed for the scope, <code>
   * false
   * </code> otherwise
   */
  ...
  /**
   * Can add child scope flag. <code>
   * true
   * </code> if scope is allowed to add child scopes, <code>
   * false
   * </code> otherwise
   */
  ...
  /**
   * Can handle event flag. <code>
   * true
   * </code> if events handling is allowed, <code>
   * false
   * </code> otherwise
   */
  ...
  public boolean serviceCall(IConnection conn, IServiceCall call) {
    // log.trace("serviceCall - canCallService: {} scope: {} method: {}", canCallService,
    // conn.getScope().getName(), call.getServiceMethodName());

 ...
 * interface defines the methods that are called by Red5 through an applications life. It is
 * suggested that you NOT implement this interface yourself, but instead you should subclass
 * org.red5.server.adapter.MultiThreadedApplicationAdapter or
...
public interface IApplication {
   ...
   *
   * @param app Application or room level scope. See {@link org.red5.server.api.scope.IScope} for
   *     details
   * @return
   *     <pre>
   * true

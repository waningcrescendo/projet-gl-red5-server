...
public abstract class LoaderBase implements ApplicationContextAware {
   ...
   * @throws BeansException Abstract superclass for all exceptions thrown in the beans package and
   *     subpackages
   */
  ...
  public void setWebappFolder(String webappFolder) {
    ...
    if (!fp.canRead()) {
      throw new RuntimeException(
          String.format("Webapp folder %s cannot be accessed.", webappFolder));
    }
    if (!fp.isDirectory()) {

...
public abstract class AbstractPipe implements IPipe {
  ...
  public boolean unsubscribe(IProvider provider) {
    if (providers.remove(provider)) {
      fireProviderConnectionEvent(
          provider, PipeConnectionEvent.EventType.PROVIDER_DISCONNECT, null);
  ...
  public boolean unsubscribe(IConsumer consumer) {
    if (consumers.remove(consumer)) {
      fireConsumerConnectionEvent(
          consumer, PipeConnectionEvent.EventType.CONSUMER_DISCONNECT, null);
  ...
  protected void fireConsumerConnectionEvent(
      IConsumer consumer, PipeConnectionEvent.EventType type, Map<String, Object> paramMap) {
  ...
  protected void fireProviderConnectionEvent(
      IProvider provider, PipeConnectionEvent.EventType type, Map<String, Object> paramMap) {

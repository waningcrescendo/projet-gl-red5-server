...
public class ServiceUtils {
  ...
  public static void invokeOnAllConnections(
    ...
    if (conn != null) {
      ...
      log.warn(
          "Connection was null (thread local), scope cannot be located and cannot execute invoke request");
    }
  }
   ...
   * @param method name of the method to invoke
   * @param params parameters to pass to the method
   * @deprecated Use {@link ServiceUtils#invokeOnAllScopeConnections(IScope, String, Object[],
   *     IPendingServiceCallback)} instead
   */
  @Deprecated
   ...
   * @param callback object to notify when result is received
   */
  public static void invokeOnAllScopeConnections(
      IScope scope, String method, Object[] params, IPendingServiceCallback callback) {
  ...
  public static void notifyOnAllConnections(String method, Object[] params) {
    ...
    if (conn != null) {
      ...
      log.warn(
          "Connection was null (thread local), scope cannot be located and cannot execute notify request");
    }
  }
   ...
   * @param method name of the method to notify
   * @param params parameters to pass to the method
   * @deprecated Use {@link ServiceUtils#notifyOnAllScopeConnections(IScope, String, Object[])}
   *     instead
   */
  @Deprecated

...
/**
 * A broadcast stream is a stream source to be subscribed to by clients. To subscribe to a stream
 * from your client Flash application use NetStream.play method. Broadcast stream can be saved at
 * the server-side.
 *

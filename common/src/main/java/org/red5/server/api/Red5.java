 ...
 *
 * <p>The code below shows various uses. <br>
 *
 * <pre>
...
public final class Red5 {
  ...
  private static final ThreadLocal<WeakReference<IConnection>> connThreadLocal =
  ...
  public static final String FMS_VERSION = "RED5/1,3,36,0";

  /** Server capabilities */
  public static final Integer CAPABILITIES = Integer.valueOf(33);

  /**
   * Target for ChunkSize messaging in RTMP. Defaulting to 128 which is the original FMS setting,
   * until modifying this is more throughly tested.
   */
  ...
  public static void setConnectionLocal(IConnection connection) {
    if (isDebug) {
      log.debug(
          ...
          (connection != null ? connection.getSessionId() : null),
  ...
  /**
   * Plugins ready flag. This is set to true when the PluginLauncher has completed loading all
   * plugins.
   */

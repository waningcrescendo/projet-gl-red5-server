...
public interface IClient extends IAttributeStore {
   ...
   * connection from client-side Flex/Flash app. To assign a custom ID to the client use
   *
   * <pre>
   * params
   * </pre>
   *
   * object of {@link IApplication#appConnect(IConnection, Object[])} method, that contains 2nd all
   * the rest values you pass to
   *
   * <pre>
   ...
   * @param permissions Permissions the client has in this context or
   *     <pre>
   * null
   * </pre>
   *     for no permissions.
  ...
  /**
   * Performs a bandwidth checking routine. Information may be found here:
   * http://www.adobe.com/devnet/flashmediaserver/articles/dynamic_stream_switching_04.html
   */
  public void checkBandwidth();

  /**
   * Performs a bandwidth checking callback for the client. Information may be found here:
   * http://www.adobe.com/devnet/flashmediaserver/articles/dynamic_stream_switching_04.html
   *

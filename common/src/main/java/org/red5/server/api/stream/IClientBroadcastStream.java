...
public interface IClientBroadcastStream extends IClientStream, IBroadcastStream {
  ...
  /**
   * Sets the publish-side alias for the streams name. Subsequent calls will replace an existing
  ...
  /**
   * Returns whether or not an alias is in-use / registered already; this includes both publish and
   * subscribe aliases within a server instance.
   *

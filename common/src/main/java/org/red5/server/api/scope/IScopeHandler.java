...
public interface IScopeHandler extends IEventHandler {
   ...
   * using NetConnection.connect method (see below).
   *
   * @param conn Connection object
   * @param params List of params passed from client via NetConnection.connect method. All
   *     parameters but the first one passed to NetConnection.connect method are available as params
   *     array.

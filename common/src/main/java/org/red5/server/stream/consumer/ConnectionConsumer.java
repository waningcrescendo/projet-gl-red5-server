...
public class ConnectionConsumer implements IPushableConsumer, IPipeConnectionListener {
  ...
  public ConnectionConsumer(
      RTMPConnection conn, Channel videoChannel, Channel audioChannel, Channel dataChannel) {
    log.debug(
        "Channel ids - video: {} audio: {} data: {}",
        new Object[] {videoChannel, audioChannel, dataChannel});
    this.conn = conn;
  ...
  public void pushMessage(IPipe pipe, IMessage message) {
    ...
    if (message instanceof ResetMessage) {
      ...
      if (eventTime < 0) {
        ...
        log.debug(
            "Message has negative timestamp, applying {} ts: {}", Integer.MIN_VALUE, eventTime);
      ...
      if (isTrace) {
        ...
        log.trace(
            "Class info - name: {} declaring: {} enclosing: {}",

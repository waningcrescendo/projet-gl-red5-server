 ...
 *
 * @see <a
 *     href='http://help.adobe.com/en_US/FlashMediaServer/3.5_Deving/WS5b3ccc516d4fbf351e63e3d11a0773d56e-7ffa.html'>FMS
 *     3.5 Bandwidth Doc</a>
...
public class ServerClientDetection implements IPendingServiceCallback, IBandwidthDetection {
  ...
  public void resultReceived(IPendingServiceCall call) {
    ...
    if (Call.STATUS_NOT_CONNECTED != call.getStatus()) {
      ...
      log.debug(
          "Received count: {} sent: {} timePassed: {} ms",
          new Object[] {received, packetsSent.get(), timePassed});
      switch (received) {
        case 1:
        ...
        default:
          ...
          log.debug(
              "onBWDone: kbitDown: {} deltaDown: {} deltaTime: {} latency: {} ",

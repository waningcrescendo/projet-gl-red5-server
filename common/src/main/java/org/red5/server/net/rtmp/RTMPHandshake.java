...
public abstract class RTMPHandshake implements IHandshake {
  ...
  public void calculateDigest(
    ...
    // copy bytes from handshake message starting at handshake offset into message start at index 0
    // and up-to digest position length
    System.arraycopy(handshakeMessage, handshakeOffset, message, 0, digestPos);
    // copy bytes from handshake message starting at handshake offset plus digest position plus
    // digest length

...
/**
 * Ping event, actually combination of different events. This is also known as a user control
 * message.
 */
public class Ping extends BaseEvent {
  ...
  /**
   * Represents the stream id in all cases except PING_CLIENT and PONG_SERVER where it represents
   * the local server timestamp.
   */

...
/**
 * Represents a stream action occurring on a connection or stream. This event is used to notify an
 * IEventHandler; it is not meant to be sent over the wire to clients.
 *

...
public class RTMP {
  ...
  public static final String[] states = {
    "connect", "handshake", "connected", "error", "disconnecting", "disconnected"
  };
  ...
  private final transient ConcurrentMap<Integer, ChannelInfo> channels =
  ...
  public void setLastWritePacket(int channelId, Packet packet) {
    ...
    /*
     * Packet prevPacket = writePackets.put(channelId, packet); if (prevPacket != null && prevPacket.getData() != null) { prevPacket.getData().release(); prevPacket.setData(null); }
     */
  }

...
public class Notify extends BaseEvent implements ICommand, IStreamData<Notify>, IStreamPacket {
  ...
  public String toString() {
    return call != null
        ? String.format("%s: %s", getClass().getSimpleName(), call)
        : (action != null
            ? String.format("%s action: %s", getClass().getSimpleName(), action)
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    if (log.isTraceEnabled()) {
      log.trace(
          "readExternal - transactionId: {} connectionParams: {} call: {}",
          transactionId,
          connectionParams,
          call);
    }
  ...
  public void writeExternal(ObjectOutput out) throws IOException {
    ...
    if (log.isTraceEnabled()) {
      log.trace(
          "writeExternal - transactionId: {} connectionParams: {} call: {}",
          transactionId,
          connectionParams,
          call);
    }

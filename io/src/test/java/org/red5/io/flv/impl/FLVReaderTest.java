...
public class FLVReaderTest {
  ...
  public void testFLVReaderFile() {
    ...
    String[] paths =
        new String[] {
          "target/test-classes/fixtures/h264_aac.flv",
          "target/test-classes/fixtures/h264_mp3.flv",
          "target/test-classes/fixtures/h264_speex.flv",
          "target/test-classes/fixtures/stray.flv",
          "target/test-classes/fixtures/NAPNAP.flv",
  ...
  public void testFLVReaderFileWithMetaData() {
    ...
    String[] paths =
        new String[] {
          "target/test-classes/fixtures/flashContent.flv",
          "target/test-classes/fixtures/flashContent1.flv"
        };
    try {
      for (String path : paths) {
        File file = Paths.get(path).toFile();

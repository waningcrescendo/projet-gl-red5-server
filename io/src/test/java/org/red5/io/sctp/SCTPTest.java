...
public class SCTPTest {
  ...
  public void before() {
    assumeTrue(
        System.getProperties().containsKey(CLIENT_PORT)
            && System.getProperties().containsKey(SERVER_PORT));
  }

  @Test
  public void testClientChannel()
      throws InvalidKeyException, NoSuchAlgorithmException, IOException, SctpException {

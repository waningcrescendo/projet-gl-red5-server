...
public class InputTest {
    ...
    IoBuffer data =
        IoBuffer.wrap(
            IOUtils.hexStringToByteArray(
                "02 00 0c 6f 6e 53 74 72 65 61 6d 53 65 6e 64 08 00000000 00 05 76 616c7565 02 00 01 31 00 00 09"));
  ...
  public void testZeroBasedEcmaArray() {
    ...
    byte[] stream =
        new byte[] {
          0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x30, 0x02, 0x00, 0x05, 'h', 'e', 'l', 'l', 'o', 0x00,
          0x01, 0x31, 0x02, 0x00, 0x05, 'w', 'o', 'r', 'l', 'd', 0x00, 0x00, 0x09
        };
  ...
  public void testNonZeroBasedEcmaArray() {
    ...
    byte[] stream =
        new byte[] {
          0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x31, 0x02, 0x00, 0x05, 'h', 'e', 'l', 'l', 'o', 0x00,
          0x00, 0x09
        };
    Input input = new Input(IoBuffer.wrap(stream));
    Object actual = input.readMap();

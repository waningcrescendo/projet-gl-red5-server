...
public class TagCrawler {
  ...
  /**
   * Method to get {@link TagHandler} by tag, can be overridden to change the logic of handler
   * searching
   *
  ...
  /**
   * Method to create "default" handler (the one will be used if none other handlers were found) can
   * be overridden to change the logic
   *
   * @return - this for chaining
   */

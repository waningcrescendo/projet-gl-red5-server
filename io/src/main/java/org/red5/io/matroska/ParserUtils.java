...
public class ParserUtils {
   ...
   */
  public static ArrayList<Tag> parseMasterElement(InputStream inputStream, final int size)
  ...
  /**
   * parsing tag by matroska specification <a
   * href="http://matroska.org/technical/specs/index.html">matroska spec</a>
   *
   * <p>tag = VINT id, VINT size, data
   *
   * @param inputStream - stream to get value

...
public class FLVHeader {
  ...
  public static final byte[] signature =
      new byte[] {(byte) (0x46 & 0xff), (byte) (0x4C & 0xff), (byte) (0x56 & 0xff)};

  /** FLV version */
  public static final byte version = 0x01 & 0xff; // version 1
  ...
  public void write(IoBuffer buffer) {
    ...
    buffer.put(
        (byte)
            (FLV_HEADER_FLAG_HAS_AUDIO * (flagAudio ? 1 : 0)
                + FLV_HEADER_FLAG_HAS_VIDEO * (flagVideo ? 1 : 0)));
    // data offset
    buffer.putInt(9);

...
/**
 * Represents all the actions which may be permitted on a stream. Some actions are called by client
 * implementations other than a Flash Player itself; ex "getStreamLength". If an action is not
 * specified here, the "CUSTOM" enum will be returned.
 *
...
public enum StreamAction {
  ...
  private static final Map<String, StreamAction> map = new HashMap<>(StreamAction.values().length);

 ...
 * @see <a href="http://download.macromedia.com/pub/labs/amf/amf3_spec_121207.pdf">Official Adobe
 *     AMF3 Specification</a>
...
public class AMF3 {
   ...
   * Similar to AMF 0, the structure of an XMLDocument needs to be flattened into a string
   * representation for serialization. As with other strings in AMF, the content is encoded in
   * UTF-8. XMLDocuments can be sent as a reference to a previously occurring XMLDocument instance
   * by using an index to the implicit object reference table.
   */

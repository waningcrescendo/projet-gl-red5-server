...
/**
 * Launch the Engine from a variety of sources, either through a main() or invoked through Apache
 * Daemon.
 */
public class EngineLauncher implements Daemon {
   ...
   *
   * <p>Taken lock, stock and barrel from Christopher Pierce's blog at

...
public class RTMPClient extends BaseRTMPClientHandler {
        ...
        new IoFutureListener<ConnectFuture>() {
          ...
          public void operationComplete(ConnectFuture future) {
            try {
              ...
              // disconnect this
              disconnect();
              // if there isn't an ClientExceptionHandler set, a RuntimeException may be thrown in
              // handleException
              handleException(e);
            }
          }
  ...
  /**
   * Sets the RTMP protocol, the default is "rtmp". If "rtmps" or "rtmpt" are required, the
   * appropriate client type should be selected.
   *
  ...
  public void setProtocol(String protocol) throws Exception {
    ...
    if ("rtmps".equals(protocol)
        || "rtmpt".equals(protocol)
        || "rtmpte".equals(protocol)
        || "rtmfp".equals(protocol)) {
      throw new Exception(

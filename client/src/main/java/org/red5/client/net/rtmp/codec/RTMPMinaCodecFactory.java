          ...
          public void encode(IoSession session, Object message, ProtocolEncoderOutput out)
            ...
            if (conn != null) {
              ...
              try {
                ...
                // get the buffer
                IoBuffer buf =
                    message instanceof IoBuffer ? (IoBuffer) message : getEncoder().encode(message);
                if (buf != null) {
              ...
              log.debug(
                  "Connection is no longer available for encoding, may have been closed already");
            }
          }
        };

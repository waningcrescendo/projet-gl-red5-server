...
public class WebSocketServerTest {
  ...
  //		// masked
  //		IoBuffer in = IoBuffer.wrap(new byte[] { (byte) 0x81, (byte) 0xFE, (byte) 0x00, (byte) 0xAE,
  // (byte) 0x97, (byte) 0x6A, (byte) 0xAD, (byte) 0x23, (byte) 0xEC, (byte) 0x48, (byte) 0xC9,
  // (byte) 0x42, (byte) 0xE3, (byte) 0x0B, (byte) 0x8F, (byte) 0x19, (byte) 0xEC, (byte) 0x48,
  // (byte) 0xDE, (byte) 0x46,
  //				(byte) 0xE4, (byte) 0x19, (byte) 0xC4, (byte) 0x4C, (byte) 0xF9, (byte) 0x03, (byte) 0xC9,
  // (byte) 0x01, (byte) 0xAD, (byte) 0x48, (byte) 0x9F, (byte) 0x12, (byte) 0xA3, (byte) 0x5A,
  // (byte) 0x98, (byte) 0x16, (byte) 0xA4, (byte) 0x5E, (byte) 0x9E, (byte) 0x1A, (byte) 0xAE,
  // (byte) 0x5C, (byte) 0x9A,
  //				(byte) 0x10, (byte) 0xA4, (byte) 0x5E, (byte) 0x9E, (byte) 0x01, (byte) 0xBB, (byte) 0x48,
  // (byte) 0xD8, (byte) 0x50, (byte) 0xF2, (byte) 0x18, (byte) 0xC4, (byte) 0x47, (byte) 0xB5,
  // (byte) 0x50, (byte) 0x8F, (byte) 0x4B, (byte) 0xE0, (byte) 0x03, (byte) 0xDF, (byte) 0x4D,
  // (byte) 0xA4, (byte) 0x5B,
  //				(byte) 0x9D, (byte) 0x4F, (byte) 0xA3, (byte) 0x5F, (byte) 0x9F, (byte) 0x46, (byte) 0xA6,
  // (byte) 0x53, (byte) 0xDF, (byte) 0x10, (byte) 0xFE, (byte) 0x09, (byte) 0xDC, (byte) 0x01,
  // (byte) 0xBB, (byte) 0x48, (byte) 0xDE, (byte) 0x46, (byte) 0xE4, (byte) 0x19, (byte) 0xC4,
  // (byte) 0x4C, (byte) 0xF9,
  //				(byte) 0x48, (byte) 0x97, (byte) 0x58, (byte) 0xB5, (byte) 0x0E, (byte) 0xCC, (byte) 0x57,
  // (byte) 0xF6, (byte) 0x48, (byte) 0x97, (byte) 0x57, (byte) 0xE5, (byte) 0x1F, (byte) 0xC8,
  // (byte) 0x5E, (byte) 0xBB, (byte) 0x48, (byte) 0xC8, (byte) 0x5B, (byte) 0xE3, (byte) 0x18,
  // (byte) 0xCC, (byte) 0x01,
  //				(byte) 0xAD, (byte) 0x11, (byte) 0x8F, (byte) 0x56, (byte) 0xE4, (byte) 0x0F, (byte) 0xDF,
  // (byte) 0x4D, (byte) 0xF6, (byte) 0x07, (byte) 0xC8, (byte) 0x01, (byte) 0xAD, (byte) 0x48,
  // (byte) 0xFD, (byte) 0x42 });
  //		// get results
  ...
  public void testMasked() throws Throwable {
    ...
    //        assertTrue(((WSMessage) writtenResult).getMessageType() ==
  ...
  //        // unmasked ping
  //        IoBuffer in = IoBuffer.wrap(new byte[] { (byte) 0x89, (byte) 0x05, (byte) 0x48, (byte)
  // 0x65, (byte) 0x6c, (byte) 0x6c, (byte) 0x6f });
  //        // create session and conn
  ...
  //        // masked pong
  //        IoBuffer in = IoBuffer.wrap(new byte[] { (byte) 0x8a, (byte) 0x85, (byte) 0x37, (byte)
  // 0xfa, (byte) 0x21, (byte) 0x3d, (byte) 0x7f, (byte) 0x9f, (byte) 0x4d, (byte) 0x51, (byte) 0x58
  // });
  //        // create session and conn
  //        DummySession session = new DummySession();
  //        WebSocketConnection conn = new WebSocketConnection(session);
  ...
  //        encoder.dummyEncode(session, Packet.build("Hello".getBytes(),
  // WSMessage.MessageType.TEXT), new DummyOutput());
  //        // decode
  //        DummyDecoder decoder = new DummyDecoder();
  ...
  //        // encode
  //        DummyEncoder encoder = new DummyEncoder();
  //        encoder.dummyEncode(session, Packet.build("Hello".getBytes(), MessageType.PING), new
  // DummyOutput());
  //        // decode
  //        DummyDecoder decoder = new DummyDecoder();
  //        decoder.dummyDecode(session, (IoBuffer) writtenResult, new DummyOutput());
  ...
  public class TyrusWSClient extends Endpoint {
    ...
    public void start() {
      // ClientManager mgr = ClientManager.createClient();
      ...
      try {
        ...
        if (cookie != null) {
                  ...
                  .configurator(
                      new ClientEndpointConfig.Configurator() {
                        ...
                        public void beforeRequest(Map<String, List<String>> headers) {
                          ...
                          cookieList.add(
                              String.format(
                                  "monster=\"%s\"", cookie)); // set your cookie value here
          ...
          session =
              container.connectToServer(
                  TyrusWSClient.class, URI.create("ws://localhost:8888/default?id=cafebeef0123"));
        }
  ...
  private class DummySession extends WsSession {
    ...
    // localEndpoint, wsRemoteEndpoint, wsWebSocketContainer, requestUri, requestParameterMap,

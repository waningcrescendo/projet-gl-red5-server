...
public class ReflectionUtilsTest {
  ...
  public void testReflectionUtils() {
    ...
    // call with two parameters string and int but expecting Connection as first parameter to hit on
    // 2nd call
    methodName = "doTest";
    call = new PendingCall("TestService.doTest", new Object[] {"test", 42});
    result = ReflectionUtils.findMethod(conn, call, service, methodName);
    ...
    call =
        new PendingCall(
            "TestService.doTestObjectArray",
            new Object[] {new Object[] {"test", 42}, new Object[] {"blllllaaahhh"}});
    methodName = "doTestObjectArray";
    result = ReflectionUtils.findMethod(conn, call, service, methodName);
    if (result[0] == null) {
      log.info("Result is null");
  ...
  public class TestService {
    ...
    public void doTestObjectArray(Object[] param0, Object[] param1) {
      log.info(
          "doTestObjectArray - Object array(s): {} {}",

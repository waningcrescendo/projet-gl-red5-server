...
public class PublisherConnectLoadTest {
  ...
  private static AtomicIntegerFieldUpdater<PublisherConnectLoadTest> AtomicPublishCounter =
      AtomicIntegerFieldUpdater.newUpdater(PublisherConnectLoadTest.class, "publishCount");
  ...
  public void testLivePublish(int i) throws InterruptedException {
    ...
    client.setStreamEventDispatcher(
    ...
    final INetStreamEventHandler handler =
        new INetStreamEventHandler() {
          @Override
                    ...
                    client.createStream(
                        new IPendingServiceCallback() {
                          ...
                          public void resultReceived(IPendingServiceCall call) {
                            ...
                            log.info(
                                "Create for publish: {} with stream id: {}", publishName, streamId);
  ...
  public void startPublish(RTMPClient client, String publishName) {
    ...
    executor.submit(
        () -> {
          ...
          disconnect(client);
          log.info(
              "Publishing completed: {} with {} messages published",
              publishName,
              messageCounter.get());
        });
  }

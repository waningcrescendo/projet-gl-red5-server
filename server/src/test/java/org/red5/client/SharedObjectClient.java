...
public class SharedObjectClient extends RTMPClient
    implements IPendingServiceCallback, ISharedObjectListener, ClientExceptionHandler {
  ...
  public SharedObjectClient(String server, int port, String app, String soName) {
    ...
    Object[] connectCallArguments =
        new Object[] {
          username, room, param2, webcam, param4, param5, message, param7, link, param9
        };

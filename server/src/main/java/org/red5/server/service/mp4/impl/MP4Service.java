...
public class MP4Service extends BaseStreamableFileService implements IMP4Service {
   ...
   * '.mp4' must be the first on the list because it is the default file extension for mp4 files.
   *
   * @see
   *     http://help.adobe.com/en_US/flashmediaserver/devguide/WS5b3ccc516d4fbf351e63e3d11a0773d117-7fc8.html
   */

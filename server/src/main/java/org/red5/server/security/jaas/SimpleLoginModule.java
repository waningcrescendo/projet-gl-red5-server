...
/**
 * This LoginModule authenticates a user with a password. This module comes pre-loaded with one user
 * / password pair and the ability for implementers to add additional pairs. The pre-loaded user is
 * "red5" and their password is "password".
 *
  ...
  public boolean login() throws LoginException {
    ...
    if (callbackHandler == null) {
      throw new LoginException(
          "Error: no CallbackHandler available, required to hold authentication information from the user");
    }
    ...
    try {
      ...
      throw new LoginException(
          "Error: "
              ...
              + " not available to hold authentication information");
    }

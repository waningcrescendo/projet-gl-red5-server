 ...
 * Principals may be associated with a particular <code>Subject</code> to augment it with an
 * additional identity. Authorization decisions can be based upon the Principals associated with a
 * <code>Subject</code>.
 *

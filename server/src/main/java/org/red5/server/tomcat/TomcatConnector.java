...
/**
 * Model object to contain a connector, socket address, and connection properties for a Tomcat
 * connection.
 *
...
public class TomcatConnector {
  ...
  /**
   * The address and port to which we will bind the connector. If the port is not supplied the
   * default of 5080 will be used. The address and port are to be separated by a colon ':'.
   *
  ...
  public String toString() {
    return "TomcatConnector [connector="
        + connector

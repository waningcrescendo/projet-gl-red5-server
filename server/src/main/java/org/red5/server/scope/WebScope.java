...
/**
 * Web scope is special scope that is aware of servlet context and represents scope of a Red5
 * application within a servlet container (or application server) such as Tomcat, Jetty or JBoss.
 *
 ...
 * injected thru Spring IoC context file and runs initialization process. Red5 server implementation
 * instance and ServletContext are injected as well.
 */
@ManagedResource
public class WebScope extends Scope
  ...
  public void register() {
    if (registered.compareAndSet(false, true)) {
      ...
      log.info(
          "Webscope already registered; remove the 'init-method' from your 'web.scope' bean to prevent this message in the future.");
    }
  }

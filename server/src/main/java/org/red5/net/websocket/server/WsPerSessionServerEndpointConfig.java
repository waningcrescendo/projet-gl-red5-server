...
/**
 * Wraps the provided {@link ServerEndpointConfig} and provides a per session view - the difference
 * being that the map returned by {@link #getUserProperties()} is unique to this instance rather
 * than shared with the wrapped {@link ServerEndpointConfig}.
 */
